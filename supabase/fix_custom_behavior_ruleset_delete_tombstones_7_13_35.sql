-- ADHDice 7.13.35: do not count permanently deleted Task tombstones as
-- current named Custom ruleset assignments.
-- SOURCE ONLY: author for review/application; do not apply to live Supabase automatically.
-- The tombstone row, historical selections, revisions, and Task History remain untouched.
