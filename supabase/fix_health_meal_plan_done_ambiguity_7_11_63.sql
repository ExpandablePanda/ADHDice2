-- ADHDice 7.11.63: qualify the meal-plan Done confirmation update.
...
begin
  ...
  update public.adhdice_health_meal_plan_entries as plan_row
     set confirmed_at = v_confirmed_at,
         confirmed_meal_entry_id = v_actual_id
   where plan_row.id = v_plan.id
     and plan_row.user_id = v_user_id
     and plan_row.confirmed_at is null;
