...
export function getTaskTypeTableRowSurfaceClassName(accentKey: unknown) {
  const accent = resolveTaskTypeAccent(accentKey);
  return `border-transparent ${accent.tableRowSurfaceClassName}`;
}
