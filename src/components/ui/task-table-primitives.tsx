...
export function TaskHierarchySearchChip({
  children,
  className,
  onClick,
  onPointerDown,
  ...
  return (
    <button
      {...props}
      className="inline-flex shrink-0 appearance-none border-0 bg-transparent p-0 focus-visible:rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#d9d0ff]/80 dark:focus-visible:ring-[#3b2f68]/90"
      onClick={(event) => {
    ...
    >
      <span
        className={joinClasses(
          ...
          "underline decoration-[#b9afdc] underline-offset-2 transition hover:text-[#6f57f6] hover:decoration-[#6f57f6] dark:decoration-white/35 dark:hover:text-[#cabfff] dark:hover:decoration-[#cabfff]",
          className,
        )}
      >
        {children}
