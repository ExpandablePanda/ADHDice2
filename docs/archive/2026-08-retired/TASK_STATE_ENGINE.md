...
>
> This preserved body reflects an earlier release-specific authority or diagnostic.
> Current Task State Engine authority remains at [docs/TASK_STATE_ENGINE.md](../../TASK_STATE_ENGINE.md).
> Current workspace-loading diagnostic remains at [docs/WORKSPACE_LOADING_ARCHITECTURE.md](../../WORKSPACE_LOADING_ARCHITECTURE.md).
> This archived document is historical reference only.
> Agents must not treat release-specific or uncommitted-work statements as current truth.
>
# Task State Engine
